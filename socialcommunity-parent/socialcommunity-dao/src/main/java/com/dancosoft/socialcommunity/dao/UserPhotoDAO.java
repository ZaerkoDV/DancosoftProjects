...
/**
 * <p>The interface UserPhotoDAO contain methods ads which realize in class
 * UserPhotoDAOImpl.Class UserPhotoDAOImpl use DAO pattern which describes layer
 * of data access to object. DAO layer perform link between relational and
 * object model. Model for this dao layer describied in class UserPhoto. This
 ...
 * @author Zaerko Denis
 */
public interface UserPhotoDAO extends CommonEntityDAO {
