...
/**
 * <p>
 * The interface AccountForumDAO contain methods ads which realize in class
 * AccountForumDAOImpl.Class AccountForumDAOImpl use DAO pattern which describes
 * layer of data access to object. DAO layer perform link between relational and
 * object model. Model for this dao layer describied in class AccountForum. This
 ...
 * @author Zaerko Denis
 */
public interface AccountForumDAO extends CommonEntityDAO {

	/**
	 * Method return list forum by id account. List contain forums which use in
	 * account.
	 * 
	 * @type Long
	 * @param idForum
	...
	/**
	 * Method return list forum by id account. List contain accounts which use
	 * in forum.
	 * 
	 * @type Long
	 * @param idAccount
