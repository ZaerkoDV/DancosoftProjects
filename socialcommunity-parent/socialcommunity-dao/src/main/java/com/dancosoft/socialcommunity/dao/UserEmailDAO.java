...
/**
 * <p>
 * The interface UserEmailDAO contain methods ads which realize in class
 * UserEmailDAOImpl.Class UserEmailDAOImpl use DAO pattern which describes layer
 * of data access to object. DAO layer perform link between relational and
 * object model. Model for this dao layer describied in class UserEmail. This
