...
/**
 * <p>
 * The interface AccountHistoryDAO contain methods ads which realize in class
 * AccountHistoryDAOImpl.Class AccountHistoryDAOImpl use DAO pattern which
 ...
 * AccountHistory. This interface contain ads methods which intended to access
 ...
 * which extend to this interface.Class use Spring framework to work whith
 * ORM.In particular often use HibernateTemplate for integration Hibernate and
 * Spring technologys. For work with data base use hibernate criteria.
 * 
 * @version 1.0 23.12.2015
 * @author Zaerko Denis
 */
public interface AccountHistoryDAO extends CommonEntityDAO {

	/**
	 * Method return account history by id account.If account history not exist
	 * return null
	 * 
	 * @type Long
	 * @param idAccount
	...
	/**
	 * Method return date of last visit account by id account. If date ont exist
	 * return null.
	 * 
	 * @type Long
	 * @param idAccount
