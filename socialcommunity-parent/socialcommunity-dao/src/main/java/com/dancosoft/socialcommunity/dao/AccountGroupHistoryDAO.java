...
/**
 * <p>
 * The interface AccountGroupHistoryDAO contain methods ads which realize in
 * class AccountGroupHistoryDAOImpl.Class AccountGroupHistoryDAOImpl use DAO
 * pattern which describes layer of data access to object. DAO layer perform
 * link between relational and object model. Model for this dao layer describied
 * in class AccountGroupHistory. This interface contain ads methods which
 * intended to access operation with object. Interface produce special operation
 * with object.Base operation (for any object) include as separate interface
 * CommonEntityDAO which extend to this interface.Class use Spring framework to
 * work whith ORM.In particular often use HibernateTemplate for integration
 ...
 * @author Zaerko Denis
 */
public interface AccountGroupHistoryDAO extends CommonEntityDAO {
